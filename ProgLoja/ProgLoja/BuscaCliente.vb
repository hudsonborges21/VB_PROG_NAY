...
Public Class BuscaCliente
    ...
    Private Sub BtnConsulta_Click(sender As Object, e As EventArgs) Handles BtnConsulta.Click
        AtulizarGrid("Select id, nome, cnpj, cidade From Cliente where nome like ('%" & txtConsulta.Text & "%') ", "Cliente")
    End Sub

    Private Sub BuscaCliente_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        AtulizarGrid("Select id,nome,CNPJ,cidade From Cliente", "Cliente")
    End Sub
