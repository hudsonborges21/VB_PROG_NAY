...
#Region "Metodos"
    ...
    Public Sub Incluir()
        ...
        Sql = "Insert Into Cliente" & _
            ...
            "values ( @nome, @endereco, @cidade, @bairro, @UF, @telefone, @CEP, @CNPJ, @inscrEstadual)"
        ...
        comando.Parameters.Add("@CNPJ", SqlDbType.VarChar).Value = CNPJ
        comando.Parameters.Add("@inscrEstadual", SqlDbType.VarChar).Value = Inscricao
    ...
    Public Function Consultar(ByVal codigolinha As Integer) As Boolean
        ...
        Dim sql As String
        sql = "SELECT * " & _
              "FROM Cliente where id = " & codigolinha
        ...
        If dataReader.HasRows Then
            ...
            If Not IsDBNull(dataReader("inscrEstadual")) Then vInscr = dataReader("inscrEstadual")
            Return True
    ...
    Public Function Alterar(ByVal parmCodigo As Integer) 'As Boolean
        ...
        'criando o comando sql
        Dim sql As String
        'sql = " UPDATE Cliente SET nome = '" & vNome & "', endereco = '" & vEndereco & _
        '        "', cidade = '" & vCidade & "', bairro = '" & vBairro & _
        '        "', UF = '" & vUF & "', telefone = '" & vTelefone & "', CEP = '" & vCEP & _
        '        "', inscrEstadual = '" & vInscr & "', CNPJ = '" & vCNPJ & _
        '        "' WHERE id = " & parmCodigo

        sql = "Update Cliente set nome=@nome, cnpj=@cnpj,Endereco=@endereco,cidade=@cidade, bairro=@bairro,uf=@uf,telefone=@telefone,cep=@cep, inscrEstadual =@inscrEstadual where id='" & parmCodigo & "'"
    ...
    Public Function Excluir(ByVal parmCodigo As Integer) As Boolean
        ...
        'criando o comando sql
        Dim sql As String
        sql = "DELETE FROM Cliente WHERE id = " & parmCodigo
